...
from qbank_mcq.core.config import Settings, load_settings
from qbank_mcq.core.db import Question, QuestionTag
from qbank_mcq.core.migrate import list_backups, restore_database

pytest.importorskip("PySide6")

from qbank_mcq.ui.settings_view import SettingsView  # noqa: E402
...
def test_changing_min_shared_rebuilds_links(workspace, monkeypatch) -> None:
    ...
    from qbank_mcq.ui import settings_view as module
