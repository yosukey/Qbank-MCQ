...
from qbank_mcq.core.text import normalize_choice

pytest.importorskip("PySide6")

from qbank_mcq.ui.richtext import (  # noqa: E402 - importorskip の後に読む
    FormatToolBar,
    RichTextEdit,
    document_to_html,
    format_tags,
...
def test_adjacent_same_format_runs_merge(qapp) -> None:
    ...
    from qbank_mcq.ui.richtext import tags_to_format as fmt_of
