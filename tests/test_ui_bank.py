...
from itembank.core.db import Question, QuestionVersion
from itembank.core.exam import build_candidates
from itembank.core.selection import Candidate
from itembank.core.typing_rules import set_instruction

pytest.importorskip("PySide6")

from itembank.ui.bank_view import UNUSED_YEAR, BankFilter, BankTableModel, BankView  # noqa: E402
from itembank.ui.question_detail import QuestionDetail  # noqa: E402
from itembank.ui.question_editor import QuestionEditor  # noqa: E402
...
def test_reordering_choices_reuses_the_same_set(workspace) -> None:
    ...
    from itembank.core.db import ChoiceSet
