...
from qbank_mcq.core.config import (
    DEFAULT_MIN_SHARED,
    FontSettings,
    Settings,
    load_settings,
...
from qbank_mcq.core.stats import FlagThresholds
from qbank_mcq.core.typing_rules import DEFAULT_NEGATIVE_WORDS
...
def test_settings_path_follows_data_dir(isolated_data_dir: Path) -> None:
    """設定は %APPDATA%\\Qbank-MCQ に置く(設計書 §15)。"""
