...
from qbank_mcq.__main__ import build_parser
from qbank_mcq.app import GUI_MISSING_MESSAGE
from qbank_mcq.app import main as gui_main

pytest.importorskip("PySide6")

from qbank_mcq.ui.main_window import MainWindow  # noqa: E402
from qbank_mcq.ui.workspace import Workspace  # noqa: E402
...
def test_workspace_opens_and_migrates(isolated_data_dir: Path) -> None:
    ws = Workspace.open()
    try:
        from qbank_mcq.core.migrate import TARGET_VERSION, read_schema_version
...
def test_check_for_update_shows_the_result(workspace, monkeypatch) -> None:
    ...
    from qbank_mcq.core.updates import VersionInfo
    from qbank_mcq.ui import main_window as module
