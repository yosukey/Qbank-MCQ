...
``--version`` を省くと ``itembank.__version__`` を使う。スキーマ版は
...
from itembank import __version__  # noqa: E402
from itembank.core.migrate import TARGET_VERSION  # noqa: E402
from itembank.core.updates import VersionInfo  # noqa: E402
